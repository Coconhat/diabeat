    ...
    <section className="flex-1 flex flex-col items-center px-6 pt-10 pb-20">
      <div className="w-full max-w-lg">
        ...
        <div className="mt-10 flex flex-col gap-3 animate-fade-in-up stagger-4">
          <a
            href="#"
            className="btn-press w-full px-8 py-4 bg-primary hover:bg-primary-dark text-white font-medium rounded-full transition-all text-center shadow-[0_2px_12px_-2px_rgba(45,184,122,0.35)] hover:shadow-[0_4px_20px_-2px_rgba(45,184,122,0.4)] flex items-center justify-center gap-2"
          >
