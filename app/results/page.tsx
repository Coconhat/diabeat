  ...
  const getRiskLevel = (score: number) => {
    if (score < 30)
      return {
        level: "Low",
        color: "green",
        description: "Your diabetes risk appears to be low.",
      };
    if (score < 60)
      return {
        level: "Moderate",
        color: "yellow",
        description: "You may have a moderate risk for diabetes.",
      };
    return {
      level: "High",
      color: "red",
      description: "You may be at higher risk for diabetes.",
    };
  };
  ...
  const getRecommendations = (score: number) => {
    ...
    if (score >= 60) {
      recommendations.push(
        "Consult with a healthcare provider for professional evaluation"
      );
    ...
    if (score >= 30) {
      ...
      recommendations.push(
        "Focus on a balanced diet with reduced sugar intake"
      );
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Based on the information you provided, here's your personalized
              risk assessment.
            </p>
          </div>
          ...
          <Card className="border-0 shadow-lg rounded-2xl mt-8">
            <CardHeader className="text-center">
              ...
              <p className="text-gray-600">
                Get personalized tips and reminders to help manage your diabetes
                risk.
              </p>
            </CardHeader>
            <CardContent>
              {!subscribed ? (
                <form onSubmit={handleEmailSubmit} className="max-w-md mx-auto">
                  ...
                  <p className="text-xs text-gray-500 mt-2 text-center">
                    We'll send you helpful tips and reminders. Unsubscribe
                    anytime.
                  </p>
                </form>
              ) : (
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    You'll receive helpful health tips and reminders in your
                    inbox.
                  </p>
                </div>
              )}
