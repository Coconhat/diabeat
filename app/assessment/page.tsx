...
export default function AssessmentPage() {
  ...
  const isStepValid = () => {
    switch (currentStep) {
      ...
      case 6:
        return formData.smoking && formData.activity && formData.sleep && formData.familyHistory
      default:
        return false
    }
  }
      ...
      case 1:
        return (
          <div className="space-y-6">
            <div>
              <Label className="text-base font-medium">Do you have recent medical records or test results?</Label>
              <RadioGroup
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="records-yes">Yes, I have my medical records</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="no" id="records-no" />
                  <Label htmlFor="records-no">No, I don't have medical records</Label>
                </div>
              </RadioGroup>
            </div>
          </div>
          ...
          return (
            <div className="space-y-6">
              <div>
                ...
                <Select value={formData.glucose} onValueChange={(value) => updateFormData("glucose", value)}>
                  <SelectTrigger className="mt-2">
                    <SelectValue placeholder="Select glucose level range" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="normal">Normal (70-99 mg/dL)</SelectItem>
                    <SelectItem value="prediabetic">Prediabetic (100-125 mg/dL)</SelectItem>
                    <SelectItem value="diabetic">Diabetic (126+ mg/dL)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) => updateFormData("bloodPressure", value)}
                  className="mt-2"
                >
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="bp-elevated">Elevated (120-129/less than 80)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Normal: below 5.7%, Prediabetic: 5.7-6.4%, Diabetic: 6.5% or higher
                </p>
              </div>
            </div>
          )
              ...
              <div>
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="activity-high">High (5+ times per week)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="moderate" id="activity-moderate" />
                    <Label htmlFor="activity-moderate">Moderate (2-4 times per week)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="low" id="activity-low" />
                    <Label htmlFor="activity-low">Low (less than 2 times per week)</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
        ...
        if (formData.hasRecords === "yes") {
          return (
            <div className="space-y-6">
              ...
              <div>
                <Label htmlFor="triglycerides" className="text-base font-medium">
                  Triglycerides (mg/dL)
                </Label>
                <Input
                  id="triglycerides"
                  ...
                  onChange={(e) => updateFormData("triglycerides", e.target.value)}
                  className="mt-2"
                />
                <p className="text-xs text-gray-500 mt-1">
                  Normal: Less than 150 mg/dL, Borderline high: 150-199 mg/dL, High: 200 mg/dL and above
                </p>
              </div>
            </div>
          )
              ...
              <div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="sleep-fair">Fair (6-7 hours or occasional issues)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="poor" id="sleep-poor" />
                    <Label htmlFor="sleep-poor">Poor (less than 6 hours or frequent issues)</Label>
                  </div>
                </RadioGroup>
              </div>
              <div>
                <Label className="text-base font-medium">Family History of Diabetes</Label>
                <RadioGroup
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="family-distant">Distant relatives (grandparents, aunts, uncles)</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="yes" id="family-yes" />
                    <Label htmlFor="family-yes">Close relatives (parents, siblings)</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
          ...
          <Card className="border-0 shadow-lg rounded-2xl">
            <CardHeader>
              <CardTitle className="text-xl text-gray-900">
                ...
                {currentStep === 4 && (formData.hasRecords === "yes" ? "Medical Metrics" : "Lifestyle Habits")}
                {currentStep === 5 &&
                  (formData.hasRecords === "yes" ? "Additional Medical Data" : "Additional Factors")}
