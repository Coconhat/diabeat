    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">
                Dia<span className="text-blue-400">beat</span>
              </span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Empowering individuals with AI-powered diabetes risk assessment tools for better health outcomes.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-gray-400">
                ...
                <span>support@diabeat.com</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400">
                <Phone className="w-4 h-4" />
                <span>1-800-DIABEAT</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm mb-2">© 2024 Diabeat. All rights reserved.</p>
